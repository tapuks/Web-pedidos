"""
Django settings for David_web project.
...
SECRET_KEY = 'django-insecure-wm8sj^=-qe3a3l!xzz2b=bluh^p8p0z7smp==yvr6o8-2(ybrv'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # IMPORTAMOS LA VARIABLE GLOBAL IMPORTE GLOBAL CARRITO (context_processors)
...
WSGI_APPLICATION = 'David_web.wsgi.application'
